    ...
    <div class="background" style="margin: 0 10px;">
        ...
        <div id="menu">
            <div class="group-box-row">
                ...
                //     echo "<input class='input-box' id='searchEmail' type='text' placeholder='Name...' style='width: 350px;' onkeyup='searchEmailFunctions()'>";
                // } else {
                    ...
                    <tr>
                        ...
                        if (mysqli_num_rows($account) > 0) {
                            while ($row = mysqli_fetch_assoc($account)) {
                                ...
                                <td>
                                    <div class='membership-list-menu' style='width: 100%'>
                                        <ul>
                                            <li></li>
                                        </ul>
                                    </div>
                                ...
                                <div class='group-box-row' style='justify-content:center;'>
                                    ...
                                    <input type='text' class='hide' value=" . '"' . $email . '"' . " name='getSelectedAccounts' readonly>
                                    <button class='button-icon-1''><span class='material-icons'>warning</span></button>
                                    <label class='button-icon-1' for='configSaveButton'><span class='material-icons'>save</span></label>
