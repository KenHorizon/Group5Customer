    ...
    <div class="navigation">
        <ul>
            ...
            <li class="dropdown" style="float: right;">
                <a class="account-header" id="account">
                    <div class="group-box-rows">
                        <img class="avatar" src=<?php echo $user->user()['profile'] == null ? "assets/img/default_pfp.jpeg" : $user->user()['profile']; ?>>
                        <span class="account-header-text">
                            <?php echo $user->account()['name']; ?>
                        </span>
                    </div>
                </a>
