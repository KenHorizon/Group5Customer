            ...
            <div class="profile-text">
                ...
                if (mysqli_num_rows($account) > 0) {
                    echo "<div class='group-box-column-name'>
                            ...
                            <div class='background' style='padding: 0 10px; width: 50px;'>
                                <p>" . determineUserType($validated_account_user["type"]) . "</p>
                            </div>
                        </div>";
                } else {
                ...
                <div class="group-box-column" style="width: 150px;">
                    <form id="profilePictureForm1" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST" enctype="multipart/form-data">
                        <div>
                            <label class="button-borderless" style="padding: 15px; margin-left: 0px; justify-content: center;" for="profilePictureInput" id="profilePictureEdit" name="profilePictureEdit"><i class="material-icons">edit</i>Edit Profile</label>
                ...
                <div class="profile-layout">
                    <div class="group-box-row">
                        ...
                        <div class="group-box-column">
                            <button class="button-borderless" style="padding: 15px; margin-left: 10px; width: 120px; justify-content: center;" id="bioEditButton"><i class="material-icons">edit</i>Edit</button>
                            <button class="button-borderless hide" style="padding: 15px; margin-left: 10px; width: 120px; justify-content: center;" id="bioSaveButton"><i class="material-icons">save</i>Save</button>
